...
_scripts_file_path=~/PEARG/marion/PycharmProjects/MazTrimAlign/; #Path to the script files folder.
_input_files_path=~/PEARG/marion/PycharmProjects/MazTrimAlign/$_data_set; #Path to the input files.
